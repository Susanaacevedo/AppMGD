...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { codigo: @producto.codigo, nombre: @producto.nombre, precio: @producto.precio, stock: @producto.stock } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { codigo: @producto.codigo, nombre: @producto.nombre, precio: @producto.precio, stock: @producto.stock } }
